...
((  (((car.largo/100)* (car.ancho/100)* car.pliego * (gramaje.gr * 0.001)  * 1.10 )*1000* gramaje.precio*  ((flete.precio /100)+1) /1000)   /b.cant_bolsa_pliego)                                + atr.precio + cc.precio + fr.precio + ab.precio + ((k.precio * d.precio * p.cantidad * ( (p.porcentaje / 100)+1   )) / 1000) + pf.precio + e.precio + ac.precio + cast((gi.kilo*gi.corte*gi.costo )/gi.division as decimal(10,3))) as lisa,
((  (((car.largo/100)* (car.ancho/100)* car.pliego * (gramaje.gr * 0.001)  * 1.10 )*1000* gramaje.precio*  ((flete.precio /100)+1) /1000)   /b.cant_bolsa_pliego)+  ba.precio + (im.precio * 1)  + atr.precio + cc.precio + fr.precio + ab.precio + ((k.precio * d.precio * p.cantidad * ( (p.porcentaje / 100)+1   )) / 1000) + pf.precio + e.precio + ac.precio + cast((gi.kilo*gi.corte*gi.costo )/gi.division as decimal(10,3))) as 1color,
((  (((car.largo/100)* (car.ancho/100)* car.pliego * (gramaje.gr * 0.001)  * 1.10 )*1000* gramaje.precio*  ((flete.precio /100)+1) /1000)   /b.cant_bolsa_pliego)+  ba.precio + (im.precio * 2)  + atr.precio + cc.precio + fr.precio + ab.precio + ((k.precio * d.precio * p.cantidad * ( (p.porcentaje / 100)+1   )) / 1000) + pf.precio + e.precio + ac.precio + cast((gi.kilo*gi.corte*gi.costo )/gi.division as decimal(10,3))) as 2colores,
((  (((car.largo/100)* (car.ancho/100)* car.pliego * (gramaje.gr * 0.001)  * 1.10 )*1000* gramaje.precio*  ((flete.precio /100)+1) /1000)   /b.cant_bolsa_pliego)+  ba.precio + (im.precio * 3)  + atr.precio + cc.precio + fr.precio + ab.precio + ((k.precio * d.precio * p.cantidad * ( (p.porcentaje / 100)+1   )) / 1000) + pf.precio + e.precio + ac.precio + cast((gi.kilo*gi.corte*gi.costo )/gi.division as decimal(10,3))) as 3colores,
((  (((car.largo/100)* (car.ancho/100)* car.pliego * (gramaje.gr * 0.001)  * 1.10 )*1000* gramaje.precio*  ((flete.precio /100)+1) /1000)   /b.cant_bolsa_pliego)+  ba.precio + (im.precio * 4)  + atr.precio + cc.precio + fr.precio + ab.precio + ((k.precio * d.precio * p.cantidad * ( (p.porcentaje / 100)+1   )) / 1000) + pf.precio + e.precio + ac.precio + cast((gi.kilo*gi.corte*gi.costo )/gi.division as decimal(10,3))) as 4colores,
