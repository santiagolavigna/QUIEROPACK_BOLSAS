...
function hcSelectDobleEtiqueta($NAME_SELECT,$ARREGLO,$CAMPO_VALOR,$CAMPO_ETIQUETA,$CAMPO_ETIQUETA2,$VALUE_SELECTED=""){
  //RETORNA EL HTML DE UN SELECT ESTANDAR CON LOS PARAMETROS INDICADOS
    ...
    if(isset($elem[$CAMPO_ETIQUETA2])){
       $RES.= " // $".rj($elem[$CAMPO_ETIQUETA2]);
    }
...
function hcSelectDobleEtiquetaforguillotinado($NAME_SELECT,$ARREGLO,$CAMPO_VALOR,$CAMPO_ETIQUETA,$CAMPO_ETIQUETA2,$VALUE_SELECTED=""){
  //RETORNA EL HTML DE UN SELECT ESTANDAR CON LOS PARAMETROS INDICADOS
    $RES='<select disabled class="form-control" name="'.$NAME_SELECT.'">';
...
function hcSelectDobleEtiquetaPorcentaje($NAME_SELECT,$ARREGLO,$CAMPO_VALOR,$CAMPO_ETIQUETA,$CAMPO_ETIQUETA2,$VALUE_SELECTED=""){
  //RETORNA EL HTML DE UN SELECT ESTANDAR CON LOS PARAMETROS INDICADOS
    $RES='<select class="form-control" name="'.$NAME_SELECT.'">';
...
function hcSelectTripleEtiqueta_total($NAME_SELECT,$ARREGLO,$CAMPO_VALOR,$CAMPO_ETIQUETA,$CAMPO_ETIQUETA2,$CAMPO_ETIQUETA3,$CAMPO_ETIQUETA4,$VALUE_SELECTED=""){
  //RETORNA EL HTML DE UN SELECT ESTANDAR CON LOS PARAMETROS INDICADOS
    $RES='<select class="form-control" name="'.$NAME_SELECT.'">';
    ...
    foreach ($ARREGLO as $elem ){
      ...
      if($VALUE_SELECTED==$elem[$CAMPO_VALOR]) $RES.='selected ';
      $RES.='value="'.$elem[$CAMPO_VALOR].'"> ';
      $RES.=rj((int)$elem[$CAMPO_ETIQUETA]);
    if(isset($elem[$CAMPO_ETIQUETA2])){
       $RES.= "  /  ".rj( (int) $elem[$CAMPO_ETIQUETA2]);
    }
    if(isset($elem[$CAMPO_ETIQUETA3])){
       $RES.= "  /  ".rj( (int) $elem[$CAMPO_ETIQUETA3]);
    }
    if($CAMPO_ETIQUETA4 === 'total_calculado'){
       $RES.= "= $ ". (    (($elem['precio_kilo'] + $elem['gillotinado'])* (0.01 * (int)$elem['flete'])) +  $elem['precio_kilo'] + $elem['gillotinado'] );
    }
    $RES.= '</option>';
...
function hcSelectTripleEtiqueta($NAME_SELECT,$ARREGLO,$CAMPO_VALOR,$CAMPO_ETIQUETA,$CAMPO_ETIQUETA2,$CAMPO_ETIQUETA3,$VALUE_SELECTED=""){
  //RETORNA EL HTML DE UN SELECT ESTANDAR CON LOS PARAMETROS INDICADOS
    $RES='<select class="form-control" name="'.$NAME_SELECT.'">';
    ...
    foreach ($ARREGLO as $elem ){
      ...
      $RES.=rj((int)$elem[$CAMPO_ETIQUETA]);
    if(isset($elem[$CAMPO_ETIQUETA2])){
       $RES.= " X ".rj((int)$elem[$CAMPO_ETIQUETA2]);
    }
    if(isset($elem[$CAMPO_ETIQUETA3])){
       $RES.= " X ".rj($elem[$CAMPO_ETIQUETA3]);
    }
    $RES.= '</option>';
...
function hcSelectDobleEtiquetaString($NAME_SELECT,$ARREGLO,$CAMPO_VALOR,$CAMPO_ETIQUETA,$CAMPO_ETIQUETA2,$CAMPO_ETIQUETA3,$VALUE_SELECTED=""){
  //RETORNA EL HTML DE UN SELECT ESTANDAR CON LOS PARAMETROS INDICADOS
...
//$options= "r|fg|lab:Titulo|ph:placeholder|pass|disabled"
  ...
  $v = validate_index($data,$name);
    ...
    $HTML.='<input';
    if (isset($o["num"])) $HTML.=' type="number" step="0.001"';
