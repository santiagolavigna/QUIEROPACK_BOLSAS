...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form id="formProducts" method="post" action="?p=<?php echo $modulo_name?>|<?php echo $action_phpfile?>&altaModif">
            ...
            <div class="col-md-6">
                <?=hcSimpleInput("nombre",$us,"fg|lab|ph:Nombre guillotinado...")?>
                <?=hcSimpleInput("kilo",$us,"fg|lab|num|req")?>
                <?=hcSimpleInput("corte",$us,"fg|lab|num|req")?>
                <?=hcSimpleInput("costo",$us,"fg|lab|num|req")?>
